    ...
    form.addEventListener('submit', async function (e) {
      ...
      try {
        ...
        if (res.ok) {
          ...
          formMsg.textContent = '✓ ¡Mensaje enviado! Te contactamos a la brevedad.';
          form.reset();
        } else {
          const json = await res.json();
          if (json.errors) {
            formMsg.className = 'form-msg error';
            formMsg.textContent = '✗ ' + json.errors.map(function (e) { return e.message; }).join(', ');
          } else {
        ...
        formMsg.className = 'form-msg error';
        formMsg.textContent = '✗ Hubo un error. Por favor contactanos por WhatsApp.';
      }

      submitBtn.textContent = 'SOLICITÁ TU PRESUPUESTO';
